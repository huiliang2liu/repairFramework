...
import com.xh.http.able.Cancelable;
import com.xh.http.able.Finishable;
import com.xh.http.able.Startable;
import com.xh.http.ssl.SSLUtils;
import com.xh.http.tools.CounterOutputStream;
import com.xh.http.tools.HeaderUtils;
import com.xh.http.tools.IOUtils;
import com.xh.http.tools.MultiValueMap;
...
public class BasicRequest<T extends BasicRequest> implements Comparable<BasicRequest>, Startable, Cancelable, Finishable {
     ...
     * SSLSockets.
     */
    private SSLSocketFactory mSSLSocketFactory = XhOkHttp.getInitializeConfig().getSSLSocketFactory();
    /**
     * HostnameVerifier.
     */
    private HostnameVerifier mHostnameVerifier = XhOkHttp.getInitializeConfig().getHostnameVerifier();
    /**
     * Connect timeout of handle.
     */
    private int mConnectTimeout = XhOkHttp.getInitializeConfig().getConnectTimeout();
    /**
     * Read data timeout.
     */
    private int mReadTimeout = XhOkHttp.getInitializeConfig().getReadTimeout();
    /**
     * After the failure of retries.
     */
    private int mRetryCount = XhOkHttp.getInitializeConfig().getRetryCount();
    /**
     * The params encoding.
     */
    ...
    public BasicRequest(String url, RequestMethod requestMethod) {
        ...
        MultiValueMap<String, String> globalHeaders = XhOkHttp.getInitializeConfig().getHeaders();
        ...
        mParams = new Params();
        MultiValueMap<String, String> globalParams = XhOkHttp.getInitializeConfig().getParams();
