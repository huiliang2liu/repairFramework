...
import static com.xh.http.tools.NetUtils.NetType.Mobile;
import static com.xh.http.tools.NetUtils.NetType.Mobile2G;
import static com.xh.http.tools.NetUtils.NetType.Mobile3G;
import static com.xh.http.tools.NetUtils.NetType.Mobile4G;
import static com.xh.http.tools.NetUtils.NetType.Wifi;
...
public class NetUtils {
    ...
    private static ConnectivityManager getConnectivityManager() {
        if (sConnectivityManager == null) {
            synchronized (NetUtils.class) {
                if (sConnectivityManager == null)
                    sConnectivityManager = (ConnectivityManager) XhOkHttp.getContext().getSystemService(Context.CONNECTIVITY_SERVICE);
            }
        }
    ...
    public static void openSetting() {
        ...
        XhOkHttp.getContext().startActivity(settingIntent);
    }
