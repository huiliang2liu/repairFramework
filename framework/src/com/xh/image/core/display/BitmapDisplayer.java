 ...
 * {@link com.rapid.universalimageloader.core.imageaware.ImageAware}.
 * Implementations can apply some changes to Bitmap or any animation for
 * displaying Bitmap.<br />
 * Implementations have to be thread-safe.
 * 
 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
 * @see com.rapid.universalimageloader.core.imageaware.ImageAware
 * @see com.rapid.universalimageloader.core.assist.LoadedFrom
 * @since 1.5.6
 */
public abstract class BitmapDisplayer {
	 ...
	 *            Source bitmap
	 * @param imageAware
	 *            {@linkplain com.rapid.universalimageloader.core.imageaware.ImageAware
	...
	public BitmapDisplayer set_zoom(boolean zoom) {
		this.zoom = zoom;
		return this;
	}
}
