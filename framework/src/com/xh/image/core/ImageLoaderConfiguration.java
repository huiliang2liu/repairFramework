 ...
 *******************************************************************************/
package com.xh.image.core;

import android.content.Context;
import android.content.res.Resources;
import android.util.DisplayMetrics;
import com.xh.image.cache.disc.DiskCache;
import com.xh.image.cache.disc.naming.FileNameGenerator;
import com.xh.image.cache.memory.MemoryCache;
import com.xh.image.cache.memory.impl.FuzzyKeyMemoryCache;
import com.xh.image.core.assist.FlushedInputStream;
import com.xh.image.core.assist.ImageSize;
import com.xh.image.core.assist.QueueProcessingType;
import com.xh.image.core.decode.ImageDecoder;
import com.xh.image.core.download.ImageDownloader;
import com.xh.image.core.process.BitmapProcessor;
import com.xh.image.utils.L;
import com.xh.image.utils.MemoryCacheUtils;
...
public final class ImageLoaderConfiguration {
	 ...
	 * <li>diskCache = {@link com.xh.image.cache.disc.impl.UnlimitedDiskCache}</li>
	...
	public static class Builder {
		...
		/**
		 * @deprecated Use
		 * {@link #diskCacheExtraOptions(int, int, com.xh.image.core.process.BitmapProcessor)}
		 * instead
		 */
		@Deprecated
		 ...
		 * {@link com.xh.image.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.xh.image.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.xh.image.cache.disc.impl.ext.LruDiskCache LruDiskCache}
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(com.xh.image.cache.disc.naming.FileNameGenerator)} */
		@Deprecated
		 ...
		 * Default value -
		 * {@link com.xh.image.core.DefaultConfigurationFactory#createFileNameGenerator()
		...
		/** @deprecated Use {@link #diskCache(com.xh.image.cache.disc.DiskCache)} */
		@Deprecated
		 ...
		 * Default value - {@link com.xh.image.cache.disc.impl.UnlimitedDiskCache
		 * UnlimitedDiskCache}. Cache directory is defined by
		 * {@link com.xh.image.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Default value -
		 * {@link com.xh.image.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.xh.image.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Consider {@link com.xh.image.utils.L#disableLogging()} to disable
	 ...
	 * using {@link com.xh.image.core.assist.FlushedInputStream}.
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 * @since 1.8.1
	 */
