...
import com.xh.json.JsonElement;
import com.xh.json.JsonIOException;
import com.xh.json.JsonNull;
import com.xh.json.JsonObject;
import com.xh.json.JsonPrimitive;
...
import com.xh.json.internal.LazilyParsedNumber;
...
public final class TypeAdapters {
  ...
  public static final TypeAdapterFactory TIMESTAMP_FACTORY = new TypeAdapterFactory() {
    ...
    @Override public <T> TypeAdapter<T> create(Json gson, TypeToken<T> typeToken) {
  ...
  public static <T1> TypeAdapterFactory newTypeHierarchyFactory(
    ...
    return new TypeAdapterFactory() {
      ...
      @Override public <T2> TypeAdapter<T2> create(Json gson, TypeToken<T2> typeToken) {
